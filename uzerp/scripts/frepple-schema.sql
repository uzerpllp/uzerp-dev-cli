...
ALTER SCHEMA frepple OWNER TO "www-data";
...
ALTER TABLE frepple.end_item_selection OWNER TO "www-data";
...
ALTER TABLE frepple.item_selection OWNER TO "www-data";
...
ALTER TABLE frepple.buffers OWNER TO "www-data";
...
ALTER TABLE frepple.customers OWNER TO "www-data";
...
ALTER TABLE frepple.item_suppliers OWNER TO "www-data";
...
ALTER TABLE frepple.items OWNER TO "www-data";
...
ALTER TABLE frepple.locations OWNER TO "www-data";
...
ALTER TABLE frepple.manufacturing_orders OWNER TO "www-data";
...
ALTER TABLE frepple.operation_materials OWNER TO "www-data";
...
ALTER TABLE frepple.operation_resources OWNER TO "www-data";
...
ALTER TABLE frepple.operations OWNER TO "www-data";
...
ALTER TABLE frepple.purchase_orders OWNER TO "www-data";
...
ALTER TABLE frepple.resources OWNER TO "www-data";
...
ALTER TABLE frepple.sales_orders OWNER TO "www-data";
...
ALTER TABLE frepple.suppliers OWNER TO "www-data";
...
ALTER TABLE frepple.uzerp_auth OWNER TO "www-data";
